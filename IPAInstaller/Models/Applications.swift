...
func handleApplicationImport(_ path: URL) throws -> Application {
    ...
    if path.pathExtension == "ipa" {
        ...
        return Application(name: "TestFlight", bundleID: "com.apple.TestFlight", path: newDestinationURL, isSystemApp: false, isInstalledWithInstaller: true, icon: appIcon)
        
        
    }
    return Application(name: "TestFlight", bundleID: "com.apple.TestFlight", path: URL(string: "")!, isSystemApp: false, isInstalledWithInstaller: true, icon: UIImage(systemName: "gear")!)
}
